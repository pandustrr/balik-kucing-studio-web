...
@section('content')
    <!-- Hero Section -->
    <section class="relative min-h-screen flex items-center pt-32 pb-20 px-8 md:px-16 lg:px-24 overflow-hidden">
        <!-- Background Image -->
                ...
                <div class="relative order-2 lg:order-1 reveal-item">
                    ...
                    <div class="relative grid grid-cols-2 gap-6 scale-90 md:scale-100">
                        <div class="space-y-6 pt-12">
                            <div
                                class="aspect-[4/5] glass rounded-[40px] p-8 flex flex-col justify-between group transition-all duration-500 hover:bg-bk-orange hover:border-transparent cursor-pointer">
                        ...
                        <div class="space-y-6">
                            ...
                            <div
                                class="aspect-[4/5] glass border-2 border-bk-orange/30 rounded-[40px] p-8 flex flex-col justify-between group transition-all duration-500 hover:bg-bk-orange hover:border-transparent cursor-pointer">
                                <h5
        ...
        <div class="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 reveal-group">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="reveal-item glass p-10 rounded-[40px] space-y-6 hover:border-bk-orange/30 transition-all group">
                    <div
                        class="w-16 h-16 bg-bk-orange/10 rounded-2xl flex items-center justify-center group-hover:bg-bk-orange group-hover:scale-110 transition-all">
                    ...
                    <p class="opacity-60 leading-relaxed">Tidak ada copy-paste. Setiap garis digambar manual dengan dedikasi
                        penuh untuk
                ...
                <div class="reveal-item glass p-10 rounded-[40px] space-y-6 hover:border-bk-orange/30 transition-all group">
                    ...
                    <p class="opacity-60 leading-relaxed">Desain yang bagus adalah desain yang bisa dimengerti tanpa perlu
                        banyak kata-kata.
                        Padat dan jelas.</p>
                </div>
                ...
                <div class="reveal-item glass p-10 rounded-[40px] space-y-6 hover:border-bk-orange/30 transition-all group">
                    ...
                    <p class="opacity-60 leading-relaxed">Kreativitas tingkat tinggi adalah hak semua orang. Kami
    ...
    <section class="py-24 bg-background">
        <div class="max-w-4xl mx-auto px-8 md:px-16 lg:px-24 reveal-item">
            <div class="glass p-12 rounded-[48px] border-bk-orange/20 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-lg opacity-60 mb-8 max-w-2xl mx-auto">Mari wujudkan visi kreatif Anda bersama tim yang
                        passionate dan berpengalaman!</p>

                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button
                            class="px-10 py-5 bg-bk-orange text-white rounded-2xl font-black text-lg shadow-xl shadow-bk-orange/20 hover:scale-105 active:scale-95 transition-all">
                            HUBUNGI KAMI 🚀
                        </button>
                        <button
                            class="px-10 py-5 glass border-bk-orange/20 text-foreground dark:text-white rounded-2xl font-black text-lg hover:bg-white/10 transition-all">
                            LIHAT PORTFOLIO
                        </button>
                    </div>
                </div>
