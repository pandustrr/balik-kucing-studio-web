...
@section('content')
    <!-- Herbukano Section -->
    <section id="home" class="relative min-h-screen flex items-center pt-32 pb-20 px-8 md:px-16 lg:px-24 overflow-hidden">
        <!-- Background Image -->
            ...
            <div class="grid lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-8 space-y-12 text-center lg:text-left">
                    ...
                    <div class="space-y-4 reveal-item">
                        <h1
                            class="text-4xl md:text-6xl lg:text-[80px] font-heading font-black leading-[0.9] tracking-tighter text-white drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
                ...
                <div class="lg:col-span-4 hidden lg:block reveal-item">
                    <div
                        class="glass p-12 rounded-[48px] space-y-12 border-bk-orange/20 relative overflow-hidden group shadow-xl">
                        <div
                            class="absolute -top-12 -right-12 w-32 h-32 bg-bk-orange/10 rounded-full blur-xl group-hover:bg-bk-orange/30 transition-all duration-700">
                        </div>
    ...
    <div
        class="relative py-8 bg-foreground dark:bg-ultra-black overflow-hidden border-y border-foreground/5 dark:border-white/5 shadow-inner">
        <div class="flex whitespace-nowrap animate-marquee">
            @for ($i = 0; $i < 4; $i++)
                <div class="flex items-center gap-12 px-8 md:px-16 lg:px-24">
                    ...
                    <span class="text-4xl md:text-6xl font-heading font-black text-transparent text-outline"
                        style="-webkit-text-stroke: 1px var(--background); opacity: 0.2;">RASA JERUK</span>
    ...
    <section id="layanan" class="relative py-32 bg-background overflow-hidden">
                        ...
                        <div class="relative grid grid-cols-2 gap-6 scale-90 md:scale-100">
                            <div class="space-y-6 pt-12">
                                <div
                                    ...
                                    <h5 class="text-4xl font-heading font-black group-hover:text-white transition-colors">
                                        SIAPA
                                    </h5>
                    ...
                    <div class="space-y-12 order-1 lg:order-2 reveal-item">
                        ...
                        <div class="space-y-8">
                            <p class="text-2xl opacity-70 leading-relaxed font-medium">
                                Balik Kucing Studio lahir dari semangat untuk memberikan solusi visual yang tidak hanya
                                cantik
        ...
        <section id="portfolio-highlight"
            class="relative py-32 bg-background text-foreground transition-colors duration-500 overflow-hidden">
            <!-- Section Title Background -->
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10 reveal-group">
                    ...
                    <a href="#"
                        ...
                        <div
                            ...
                            <p
                                class="text-bk-orange font-black tracking-widest text-xs uppercase opacity-0 group-hover:opacity-100 transition-opacity">
                                Branding & Identity</p>
                            <h4
                                class="text-4xl font-heading font-black text-foreground group-hover:text-white transition-colors">
                                Orange Soda Rebrand</h4>
                            <div class="h-px w-0 group-hover:w-full bg-white/20 transition-all duration-700 delay-100">
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <div
                            ...
                            <p
                                class="text-bk-orange font-black tracking-widest text-xs uppercase opacity-0 group-hover:opacity-100 transition-opacity">
                                Merchandise Design</p>
                            <h4
                                class="text-4xl font-heading font-black text-foreground group-hover:text-white transition-colors">
                                Sticker Pack Vol.1</h4>
                            <div class="h-px w-0 group-hover:w-full bg-white/20 transition-all duration-700 delay-100">
                            </div>
                        </div>
                    </a>
