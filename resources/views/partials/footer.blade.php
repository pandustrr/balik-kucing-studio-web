<!-- Footer -->
<footer id="contact" class="relative mt-20 pt-24 pb-12 bg-background dark:bg-ultra-black text-foreground dark:text-white transition-colors duration-500 border-t border-foreground/5 dark:border-white/5">
    <!-- Background Decor -->
    <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-bk-orange/5 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div class="grid lg:grid-cols-12 gap-16 pb-20 border-b border-foreground/10 dark:border-white/10">
            ...
            <div class="lg:col-span-5 space-y-8">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-bk-orange rounded-xl flex items-center justify-center text-white font-black text-xl shadow-lg shadow-bk-orange/30">BK</div>
                    <span class="text-2xl font-heading font-black tracking-tighter">BALIKKUCING <span class="text-bk-orange">STUDIO.</span></span>
                </div>
