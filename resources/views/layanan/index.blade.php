...
@section('content')
    <!-- Hero Section -->
    <section class="relative pt-48 pb-24 px-8 md:px-16 lg:px-24 overflow-hidden min-h-screen flex items-center">
        <!-- Background Image -->
        ...
        <div class="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
            <h2
                class="text-[20vw] font-heading font-black opacity-[0.03] dark:opacity-[0.05] whitespace-nowrap leading-none transform rotate-12 uppercase">
                OUR SERVICES
            </h2>
        </div>

        <!-- Section Title Background (Decorative Label) -->
        <div class="absolute top-0 left-1/2 -translate-x-1/2 pointer-events-none select-none">
            <h2
                class="text-[25vw] font-heading font-black opacity-[0.02] dark:opacity-[0.03] leading-none tracking-tighter uppercase">
                LAYANAN
            </h2>
        </div>
        ...
        <div class="max-w-7xl mx-auto relative reveal-group z-10 text-center">
            <div class="max-w-3xl mx-auto space-y-8">
                ...
                <p class="max-w-2xl mx-auto text-xl opacity-60 mt-8 reveal-item leading-relaxed">
    ...
    <section id="layanan" class="relative py-32 bg-background overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 relative reveal-group">
                    ...
                    <div class="relative z-10 space-y-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="opacity-60 leading-relaxed font-medium">
                                Solusi identitas visual, UI/UX, dan kebutuhan branding digital yang <span
                                    class="italic text-bk-orange">affordable</span> namun tetap berkualitas tinggi.
                            </p>
                            ...
                            <ul class="space-y-2 pt-4 border-t border-foreground/5 dark:border-white/5">
                                <li class="flex items-center gap-2 text-sm opacity-70">
                                    <svg class="w-4 h-4 text-bk-orange" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                        ...
                        <div
                            class="inline-flex items-center gap-2 font-black text-xs tracking-widest uppercase text-bk-orange group-hover:gap-4 transition-all cursor-pointer">
    ...
    <section class="py-32 bg-foreground/5 dark:bg-black/20 overflow-hidden">
        <div class="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 reveal-group">
            <div class="grid lg:grid-cols-2 gap-24 items-center">
                <div class="reveal-item">
                    <h3 class="text-4xl md:text-5xl font-heading font-black mb-12 italic">Kenapa Harus <br><span
                            class="text-bk-orange uppercase">Balik Kucing?</span></h3>
                    <div class="space-y-10">
                        <div class="flex gap-6">
                            <div
                                class="w-14 h-14 bg-bk-orange/10 rounded-2xl flex items-center justify-center shrink-0 group-hover:bg-bk-orange transition-all duration-500">
                                <span class="text-bk-orange font-heading font-black text-xl">01</span>
                            </div>
                            <div>
                                <h5 class="font-bold text-xl mb-2">Kualitas Premium, Harga Ramah</h5>
                                <p class="opacity-60 leading-relaxed">Kami percaya desain bagus tidak harus selalu mahal.
                                    Kami menawarkan paket yang fleksibel untuk UMKM hingga Startup.</p>
                            </div>
                        </div>
                        <div class="flex gap-6">
                            <div
                                class="w-14 h-14 bg-bk-orange/10 rounded-2xl flex items-center justify-center shrink-0 group-hover:bg-bk-orange transition-all duration-500">
                                <span class="text-bk-orange font-heading font-black text-xl">02</span>
                            </div>
                            <div>
                                <h5 class="font-bold text-xl mb-2">Proses Kreatif yang Terbuka</h5>
                                <p class="opacity-60 leading-relaxed">Anda dilibatkan dalam setiap tahap, dari brainstorming
                                    ide hingga revisi akhir yang memuaskan.</p>
                            </div>
                        </div>
                        <div class="flex gap-6">
                            <div
                                class="w-14 h-14 bg-bk-orange/10 rounded-2xl flex items-center justify-center shrink-0 group-hover:bg-bk-orange transition-all duration-500">
                                <span class="text-bk-orange font-heading font-black text-xl">03</span>
                            </div>
                            <div>
                                <h5 class="font-bold text-xl mb-2">Turnaround Time Cepat</h5>
                                <p class="opacity-60 leading-relaxed">Kami memahami deadline Anda. Proses kerja yang efisien
                                    tanpa mengorbankan kualitas estetika.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="reveal-item relative">
                    <div class="absolute -inset-4 bg-bk-orange/10 blur-3xl rounded-full opacity-50"></div>
                    <div class="relative glass p-10 md:p-12 rounded-[48px] border-bk-orange/20">
                        <h4 class="text-2xl font-heading font-black mb-8 italic">Siap Memulai Proyek Anda?</h4>
                        <form class="space-y-5">
                            <div class="space-y-2">
                                <label class="text-[9px] font-black uppercase tracking-[0.2em] opacity-40 ml-2">Nama
                                    Anda</label>
                                <input type="text" placeholder="Jaki San"
                                    class="w-full bg-foreground/5 dark:bg-white/5 border border-foreground/10 dark:border-white/10 rounded-2xl px-6 py-4 focus:outline-none focus:border-bk-orange transition-all">
                            </div>
                            <div class="space-y-2">
                                <label class="text-[9px] font-black uppercase tracking-[0.2em] opacity-40 ml-2">Pilih
                                    Layanan</label>
                                <select
                                    class="w-full bg-foreground/5 dark:bg-white/5 border border-foreground/10 dark:border-white/10 rounded-2xl px-6 py-4 focus:outline-none focus:border-bk-orange appearance-none transition-all cursor-pointer">
                            ...
                            <button
                                class="w-full bg-bk-orange text-white py-5 rounded-2xl font-black text-lg shadow-xl shadow-bk-orange/20 hover:scale-[1.02] active:scale-95 transition-all mt-4">
                                KONSULTASI GRATIS 🚀
                            </button>
                        </form>
                    </div>
